...
class TestCreateOrder:
    ...
    def test_create_order_two_ingredient_order_created(self, user_auth, ingredient):
        response_order = ApiMethod.api_method_create_order_auth(user_auth, ingredient[0], ingredient[1])
    ...
    def test_create_order_no_ingredient_order_error_response(self, user_auth):
        response_order = ApiMethod.api_method_create_order_auth_no_ingredients(user_auth)
    ...
    def test_create_order_incorrect_two_hash_order_error_response(self, user_auth):
        response_order = ApiMethod.api_method_create_order_auth(user_auth, "124", "123")
